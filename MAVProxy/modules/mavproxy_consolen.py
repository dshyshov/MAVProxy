...
class ConsoleModule(mp_module.MPModule):
	...
	mpstate.console.set_status('HomeDist', 'Home_Distance ---', row=3)
	...
	if type == 'GPS_RAW_INT':
	    ...
	    self.console.set_status('HomeDist', 'HomeDist %u' % home_dist)
        ...
        if type in [ 'GPS_RAW', 'GPS_RAW_INT' ]:
            ...
            if ((msg.fix_type == 3 and master.mavlink10()) or
                ...
                self.console.set_status('GPS', 'GPS: OK (%s)' % sats_string, fg='darkgreen')
            else:
            ...
            self.console.set_status('Srv', 'Srv %.2f' % (msg.Vservo*0.001), fg='darkgreen')
